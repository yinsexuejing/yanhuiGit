 ...
 * areaBlock : 回调省份城市和区域
 */
+ (instancetype)areaPickerViewWithProvince:(NSString *)province provinceID:(NSString *)provinceID city:(NSString *)city cityID:(NSString *)cityID area:(NSString *)area areaID:(NSString *)areaID areaBlock:(void(^)(NSString *province, NSString *provinceID, NSString *city,NSString *pCITYid, NSString *area, NSString *areaID))areaBlock;
