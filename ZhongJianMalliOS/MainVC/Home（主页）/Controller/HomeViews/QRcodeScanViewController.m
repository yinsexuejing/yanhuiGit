...
#define TOP (KHEIGHT-220)/2
#define LEFT (KWIDTH-220)/2
...
//    backButton.frame = CGRectMake(0, 0, 64, 30);
...
- (void)setupCamera
{
    ...
    //设置扫描区域
    CGFloat top = TOP/KHEIGHT;
    CGFloat left = LEFT/KWIDTH;
    CGFloat width = 220/KWIDTH;
    CGFloat height = 220/KHEIGHT;
