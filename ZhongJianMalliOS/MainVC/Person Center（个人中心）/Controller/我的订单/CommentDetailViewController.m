...
static NSString *const timeCellID = @"DetailTimerCell";
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        ...
        DetailTimerCell *timeCell = [[DetailTimerCell alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:timeCellID];
        if ([dataDiction count] > 0) {
            ...
            timeCell.shopTimeLabel.text = [NSString stringWithFormat:@"%@",dataDiction[@"expressno"]];
            timeCell.sendTimeLabel.text = [NSString stringWithFormat:@"%@",dataDiction[@"expressname"]];
        }
