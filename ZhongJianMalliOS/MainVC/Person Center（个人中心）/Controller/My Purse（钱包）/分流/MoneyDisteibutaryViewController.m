//
//  MoneyDisteibutaryViewController.m
//  ZhongJianMalliOS
//
...
#import "DistribtaryPassViewController.h"
@interface MoneyDisteibutaryViewController ()<UITableViewDelegate,UITableViewDataSource> {
...
@implementation MoneyDisteibutaryViewController
...
- (void)sendButtonClick:(UIButton *)sender {
    if (dataArr.count > 0) {
        ...
        DistribtaryPassViewController *alert = [DistribtaryPassViewController new];
        
        [self presentViewController:alert animated:YES completion:^{
            alert.type = _type;
            alert.toUserId = sysID;
