//
//  DistribtaryPassViewController.m
//  ZhongJianMalliOS
//
...
@interface DistribtaryPassViewController (){
    NSString *inputss;
}
...
@implementation DistribtaryPassViewController
...
- (void)requestData {
    ...
    NSUserDefaults *user = [NSUserDefaults standardUserDefaults];
    NSString *token = [user objectForKey:@"userToken"];
    NSString *url = [NSString stringWithFormat:@"%@%@%@",HTTPUrl,@"/zjapp/v1/MemberShip/SplitStream/",token];
