...
@interface AttornPassViewController (){
    NSString *inputss;
}
...
@implementation AttornPassViewController
...
- (void)requestData {
    ...
    NSString *url = [NSString stringWithFormat:@"%@%@%@",HTTPUrl,@"/zjapp/v1/MemberShip/TransferOfMoney/",token];
